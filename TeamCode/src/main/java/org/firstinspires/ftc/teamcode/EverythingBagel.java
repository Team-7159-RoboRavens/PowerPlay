...
public class EverythingBagel extends LinearOpMode {
...
//            rControl[claw].claw();
    ...
    // either Driver and Claw interface
    // or we could instead of making an interface, just do methods for each person
    // this is more expandable though.
    // This is the best if each person will only drive or claw
    ...
    // with a list of those interfaces, one for each person
    // most easily expandable, I really like this one
    // Though it looks a little messy
